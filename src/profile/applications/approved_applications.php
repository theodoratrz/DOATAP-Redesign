...
function echoPagination()
{
  ...
  $temp = getAllApplications('approved', $currentPage, '5', 'ASC');
  ...
  echo '<table class="table" style="text-align:center">
        ...
        <nav aria-label="...">
          <ul class="pagination">
              ...
              <a class="page-link" '. ($hasPrevious ? 'href="/approved_applications.php?page='. ($currentPage - 1) .'"' : '') .'>
                Previous
              </a>
              </li>
              ...
              <a class="page-link" '. ($hasNext ? 'href="/approved_applications.php?page='. ($currentPage + 1) .'"' : '') .'>
                Next
              </a>
              </li>
          </ul>
...
<body>
  <div class="page-container fluid-container">
    ...
    <div class="page-content-container">
      ...
      echoSidebar("/profile/applications/approved_applications.php/");
      ?>
