  ...
  echo '<table class="table" style="text-align:center">
          ...
          foreach ($applications as $application) {
            echo '
                <tr>
                  ...
                  <td>
                    <div>
                      <a href="show_application.php?app_id=' . $application["app_id"] . '"
        ...
        <nav aria-label="...">
          <ul class="pagination">
              ...
              <a class="page-link" '. ($hasPrevious ? 'href="submitted_applications.php?page='. ($currentPage - 1) .'"' : '') .'>
                Previous
              </a>
              </li>
              ...
              <a class="page-link" '. ($hasNext ? 'href="submitted_applications.php?page='. ($currentPage + 1) .'"' : '') .'>
                Next
              </a>
              </li>
          </ul>
  ...
  <div class="page-container fluid-container">
    ...
    <div class="gray-box">
      <a href="index.php" class="fas fa-arrow-circle-left" style="text-decoration:none; color:#002E69; cursor:pointer; 
            margin-left:13rem;margin-top:2%;"> Αιτήσεις που έχουν Υποβληθεί</a>
      <div class="breadcrumb" style="align-items:end;">
        ...
        <li class="breadcrumb-item active" aria-current="page" style="font-size:15px;">Αιτήσεις που έχουν Υποβληθεί</li>
      </div>
    </div>
    <div class="page-content-container">

      <?php require_once $_SERVER['DOCUMENT_ROOT'] . "/components/sidebar.php";
      echoSidebar("/profile/application_handling/submitted_applications.php/");
      ?>
