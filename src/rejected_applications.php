...
function echoPagination()
{
  ...
  $temp = getAllApplications('rejected', $currentPage, '5', 'DESC');
  ...
  echo '<table class="table" style="text-align:center">
        ...
        <nav aria-label="...">
          <ul class="pagination">
              ...
              <a class="page-link" '. ($hasPrevious ? 'href="/rejected_applications.php?page='. ($currentPage - 1) .'"' : '') .'>
                Previous
              </a>
              </li>
              ...
              <a class="page-link" '. ($hasNext ? 'href="/rejected_applications.php?page='. ($currentPage + 1) .'"' : '') .'>
                Next
              </a>
              </li>
          </ul>
...
<body>
  <div class="page-container fluid-container">
    ...
    <div class="page-content-container">
      ...
      echoSidebar("/profile/application_handling/rejected_applications.php/");
      ?>
