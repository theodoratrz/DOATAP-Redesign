    ...
    <div class="mail-wrap">
        ...
        <div class="mail-wrap">
            ...
            <div class="map-wrap">
                ...
                <span style="font-size:medium; margin-left:0rem;">Αγίου Κωνσταντίνου 54, 104 37</span>

                <i class="fas fa-map-marker" style="margin-left:6rem"></i>
                <span style="font-size:medium; margin-left:0rem;">Υπουργείο Μακεδονίας Θράκης-Διοικητήριο, 541 23</span>
            </div>
            <div class="map-wrap">
            ...
            <div class="map-wrap">
                ...
                <a href="tel:2105281000" style="font-size:medium; margin-left:0rem; text-decoration:none; color:black;">210-5281000</a>

                <i class="fas fa-phone" style="margin-left:6rem"></i>
                <a href="tel:2313501372" style="font-size:medium; margin-left:0rem; text-decoration:none; color:black;">2313-501372</a>
            </div>
        </div>
    </div>
</div>
