...
<body>
    ...
    <div class="page-container fluid-container">
        ...
        <div class="gray-box">
            <a class="fas fa-arrow-circle-left" onclick="history.back()" style="text-decoration:none; color:#002E69; cursor:pointer; margin-left:3rem;">Επικοινωνία</a>
        </div>
            ...
            <div class="mail-wrap">
                ...
                <div class="map-wrap">
                    ...
                    <div class="mail-wrap">
                        ...
                        <i class="fas fa-map-marker"><span style="font-size:medium; font-weight:normal;"> Υπουργείο Μακεδονίας Θράκης-Διοικητήριο, 541 23</span></i>
                        ...
                        <i class="fas fa-phone" style="margin-left:0rem"><a href="tel:2313501372" style="font-size:medium; font-weight:normal; text-decoration:none; color:black;"> 2313-501372</a></i>
                    </div>
                </div>
                <div class="mail-wrap" style="font-size:medium; width:50%;">
                    Η δια ζώσης εξυπηρέτηση του κοινού πραγματοποιείται από <b style="font-size:medium">Δευτέρα έως Πέμπτη και ώρες 9:00-12:00.</b>
                    Προς ανάσχεση της διασποράς του ιού, η δια ζώσης εξυπηρέτηση από υπαλλήλους περιορίζεται στο κοινό που προσέρχεται για να παραλάβει έγγραφα. Το κοινό που προσέρχεται για ενημέρωση εξυπηρετείται από υπαλλήλους τηλεφωνικά από την είσοδο του κτιρίου.
                </div>
                    <div class="mail-wrap" style="font-size:medium">
                    Τηλεφωνική εξυπηρέτηση του κοινού πραγματοποιείται από <b style="font-size:medium">Δευτέρα έως Παρασκευή και ώρες 12:30-14:00</b>
                        </div>
            </div>
        </div>
    </div>
